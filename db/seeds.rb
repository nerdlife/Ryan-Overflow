...
# , votes: 55
Question.create(title: 'Ryan User 1..... First Question Title', content: 'Ryan User 1 First Question Content Is Here',  user_id: 1,  tags: ["Html", "Css", "Javascript", "Ruby", "Rails", "Meteor"] )
Answer.create(content: 'Ryan User 1... First Answer Content Is  Here For Question ID 3', question_id: 3, user_id: 1, tags: ["Html", "Css", "Javascript", "Ruby", "Rails", "Meteor"])
Answer.create(content: 'Ryan User 1.....2nd Answer Content Is  Here For Question ID 3', question_id: 3, user_id: 1, tags: ["Html", "Css", "Javascript", "Ruby", "Rails", "Meteor"])
...
Answer.create(content: 'Moses User 2....FIRST Answer Content Is Here For Question ID 1', question_id: 1, user_id: 2 , tags: ["Mean", "Angular", "React"])
Answer.create(content: 'Moses User 2....2nd Answer Content Is Here For Question ID 1', question_id: 1, user_id: 2 , tags: ["Mean", "Angular", "React"])
Answer.create(content: 'Moses User 2....2nd Answer Content Is Here For Question ID 1', question_id: 1, user_id: 2 , tags: ["Mean", "Angular", "React"])
Answer.create(content: 'Moses User 2....2nd Answer Content Is Here For Question ID 1', question_id: 1, user_id: 2 , tags: ["Mean", "Angular", "React"])
Answer.create(content: 'Moses User 2....2nd Answer Content Is Here For Question ID 1', question_id: 1, user_id: 2 , tags: ["Mean", "Angular", "React"])
...
Answer.create(content: 'Katy User 3....First Answer Content Is Here For Question ID 2', question_id: 2, user_id: 3, tags: ["Football", "Keyboard", "Sandwich"])
Answer.create(content: 'Katy User 3....2nd Answer Content Is Here For Question ID 2', question_id: 2, user_id: 3, tags: ["Football", "Keyboard", "Sandwich"])
