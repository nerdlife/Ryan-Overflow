class QuestionsController < ApplicationController
    ...
    def index
        ...
        unless (params[:search]).blank?
            ...
            @questions = Question.search(params[:search]).order("created_at")
    ...
    def question_params
        params.require(:question).permit(:title, :content, :tags, :votes, answers_attributes: [:content, :user_id, :question_id])
    end
